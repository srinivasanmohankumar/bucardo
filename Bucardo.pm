        ...
        for my $pk_values (@pkvals) {
            ...
            ##Initializing the srccmd
                ...
                if(exists $hash1{$source_tablename}) {
                    $srccmd = sprintf '%sCOPY (%s FROM ONLY %s t1 WHERE t1.project_id=16074 %s) TO STDOUT%s',
                    $self->{sqlprefix},
                    $SELECT,
                    $source_tablename,
                ...
                ##Two Level joins initial copy logics
                    ...
                    $srccmd = sprintf '%sCOPY (%s FROM ONLY %s t1 INNER JOIN public.people t2 ON t1.person_id = t2.id WHERE t2.project_id=16074 %s) TO STDOUT%s',
                    $self->{sqlprefix},
                    $SELECT,
                    $source_tablename,
                    ...
                    $srccmd = sprintf '%sCOPY (%s FROM ONLY %s t1 INNER JOIN public.articles t2 ON t1.article_id = t2.id WHERE t2.project_id=16074 %s) TO STDOUT%s',
                    $self->{sqlprefix},
                    $SELECT,
                    $source_tablename,
                    $mode eq 'fullcopy' ? '' : " AND t1.$Table->{pklist} = ANY(?)",
                    ...
                    $srccmd = sprintf '%sCOPY (%s FROM ONLY %s t1 INNER JOIN public.categories t2 ON t1.category_id = t2.id WHERE t2.project_id=16074 %s) TO STDOUT%s',
                    $self->{sqlprefix},
                    $SELECT,
                    $source_tablename,
                    $mode eq 'fullcopy' ? '' : " AND t1.$Table->{pklist} = ANY(?)",
                    ...
                    $srccmd = sprintf '%sCOPY (%s FROM ONLY %s t1 INNER JOIN public.assignment_rules t2 ON t1.assignment_rule_id = t2.id WHERE t2.project_id=16074 %s) TO STDOUT%s',
                    $self->{sqlprefix},
                    $SELECT,
                    $source_tablename,
                    $mode eq 'fullcopy' ? '' : " AND t1.$Table->{pklist} = ANY(?)",
                    ...
                    $srccmd = sprintf '%sCOPY (%s FROM ONLY %s t1 INNER JOIN public.automation_rules t2 ON t1.automation_rule_id = t2.id WHERE t2.project_id=16074 %s) TO STDOUT%s',
                    $self->{sqlprefix},
                    $SELECT,
                    $source_tablename,
                    $mode eq 'fullcopy' ? '' : " AND t1.$Table->{pklist} = ANY(?)",
                    ...
                    $srccmd = sprintf '%sCOPY (%s FROM ONLY %s t1 INNER JOIN public.users_projects t2 ON t1.user_id = t2.user_id WHERE t2.project_id=16074 %s) TO STDOUT%s',
                    $self->{sqlprefix},
                    $SELECT,
                    $source_tablename,
                    $mode eq 'fullcopy' ? '' : " AND t1.$Table->{pklist} = ANY(?)",
                    ...
                    $srccmd = sprintf '%sCOPY (%s FROM ONLY %s t1 INNER JOIN public.messages t2 ON t1.message_id = t2.id INNER JOIN public.conversations t3 ON t2.conversation_identifier = t3.conversation_identifier WHERE t3.project_id=16074 %s) TO STDOUT%s',
                    $self->{sqlprefix},
                    $SELECT,
                    $source_tablename,
                    $mode eq 'fullcopy' ? '' : " AND t1.$Table->{pklist} = ANY(?)",
                    ...
                    $srccmd = sprintf '%sCOPY (%s FROM ONLY %s t1 INNER JOIN public.bot_components t2 ON t1.bot_component_id = t2.id WHERE t2.project_id=16074 %s) TO STDOUT%s',
                    $self->{sqlprefix},
                    $SELECT,
                    $source_tablename,
                    $mode eq 'fullcopy' ? '' : " AND t1.$Table->{pklist} = ANY(?)",
                    ...
                    $srccmd = sprintf '%sCOPY (%s FROM ONLY %s t1 INNER JOIN public.bot_components t2 ON t1.component_id = t2.id WHERE t2.project_id=16074 %s) TO STDOUT%s',
                    $self->{sqlprefix},
                    $SELECT,
                    $source_tablename,
                    $mode eq 'fullcopy' ? '' : " AND t1.$Table->{pklist} = ANY(?)",
                    ...
                    $srccmd = sprintf '%sCOPY (%s FROM ONLY %s t1 INNER JOIN public.campaigns t2 ON t1.campaign_id = t2.id WHERE t2.project_id=16074 %s) TO STDOUT%s',
                    $self->{sqlprefix},
                    $SELECT,
                    $source_tablename,
                    $mode eq 'fullcopy' ? '' : " AND t1.$Table->{pklist} = ANY(?)",
                    ...
                    $srccmd = sprintf '%sCOPY (%s FROM ONLY %s t1 INNER JOIN public.chat_tags t2 ON t1.chat_tag_id = t2.id WHERE t2.project_id=16074 %s) TO STDOUT%s',
                    $self->{sqlprefix},
                    $SELECT,
                    $source_tablename,
                    $mode eq 'fullcopy' ? '' : " AND t1.$Table->{pklist} = ANY(?)",
                    ...
                    $srccmd = sprintf '%sCOPY (%s FROM ONLY %s t1 INNER JOIN public.companies t2 ON t1.company_id = t2.id WHERE t2.project_id=16074 %s) TO STDOUT%s',
                    $self->{sqlprefix},
                    $SELECT,
                    $source_tablename,
                    $mode eq 'fullcopy' ? '' : " AND t1.$Table->{pklist} = ANY(?)",
                    ...
                    $srccmd = sprintf '%sCOPY (%s FROM ONLY %s t1 INNER JOIN public.conversation_properties t2 ON t1.conversation_property_id = t2.id WHERE t2.project_id=16074 %s) TO STDOUT%s',
                    $self->{sqlprefix},
                    $SELECT,
                    $source_tablename,
                    $mode eq 'fullcopy' ? '' : " AND t1.$Table->{pklist} = ANY(?)",
                    ...
                    $srccmd = sprintf '%sCOPY (%s FROM ONLY %s t1 INNER JOIN public.deals t2 ON t1.deal_id = t2.id WHERE t2.project_id=16074 %s) TO STDOUT%s',
                    $self->{sqlprefix},
                    $SELECT,
                    $source_tablename,
                    $mode eq 'fullcopy' ? '' : " AND t1.$Table->{pklist} = ANY(?)",
                    ...
                    $srccmd = sprintf '%sCOPY (%s FROM ONLY %s t1 INNER JOIN public.users_projects t2 ON t1.users_project_id = t2.id WHERE t2.project_id=16074 %s) TO STDOUT%s',
                    $self->{sqlprefix},
                    $SELECT,
                    $source_tablename,
                    $mode eq 'fullcopy' ? '' : " AND t1.$Table->{pklist} = ANY(?)",
                    ...
                    $srccmd = sprintf '%sCOPY (%s FROM ONLY %s t1 INNER JOIN public.settings t2 ON t1.id = t2.id WHERE t2.project_id=16074 %s) TO STDOUT%s',
                    $self->{sqlprefix},
                    $SELECT,
                    $source_tablename,
                    $mode eq 'fullcopy' ? '' : " AND t1.$Table->{pklist} = ANY(?)",
                    ...
                    $srccmd = sprintf '%sCOPY (%s FROM ONLY %s t1 INNER JOIN public.events t2 ON t1.event_id = t2.id WHERE t2.project_id=16074 %s) TO STDOUT%s',
                    $self->{sqlprefix},
                    $SELECT,
                    $source_tablename,
                    $mode eq 'fullcopy' ? '' : " AND t1.$Table->{pklist} = ANY(?)",
                    ...
                    $srccmd = sprintf '%sCOPY (%s FROM ONLY %s t1 INNER JOIN public.mail_filters t2 ON t1.mail_filter_id = t2.id WHERE t2.project_id=16074 %s) TO STDOUT%s',
                    $self->{sqlprefix},
                    $SELECT,
                    $source_tablename,
                    $mode eq 'fullcopy' ? '' : " AND t1.$Table->{pklist} = ANY(?)",
                    ...
                    $srccmd = sprintf '%sCOPY (%s FROM ONLY %s t1 INNER JOIN public.feature_tags t2 ON t1.feature_tag_id = t2.id WHERE t2.project_id=16074 %s) TO STDOUT%s',
                    $self->{sqlprefix},
                    $SELECT,
                    $source_tablename,
                    $mode eq 'fullcopy' ? '' : " AND t1.$Table->{pklist} = ANY(?)",
                    ...
                    $srccmd = sprintf '%sCOPY (%s FROM ONLY %s t1 INNER JOIN public.tags t2 ON t1.tag_id = t2.id WHERE t2.project_id=16074 %s) TO STDOUT%s',
                    $self->{sqlprefix},
                    $SELECT,
                    $source_tablename,
                    $mode eq 'fullcopy' ? '' : " AND t1.$Table->{pklist} = ANY(?)",
                    ...
                    $srccmd = sprintf '%sCOPY (%s FROM ONLY %s t1 INNER JOIN public.bots t2 ON t1.bot_id = t2.id WHERE t2.project_id=16074 %s) TO STDOUT%s',
                    $self->{sqlprefix},
                    $SELECT,
                    $source_tablename,
                    $mode eq 'fullcopy' ? '' : " AND t1.$Table->{pklist} = ANY(?)",
                    ...
                    $srccmd = sprintf '%sCOPY (%s FROM ONLY %s t1 INNER JOIN public.mail_subscriptions t2 ON t1.mail_subscription_id = t2.id WHERE t2.project_id=16074 %s) TO STDOUT%s',
                    $self->{sqlprefix},
                    $SELECT,
                    $source_tablename,
                    $mode eq 'fullcopy' ? '' : " AND t1.$Table->{pklist} = ANY(?)",
                    ...
                    $srccmd = sprintf '%sCOPY (%s FROM ONLY %s t1 INNER JOIN public.message_goals t2 ON t1.message_goal_id = t2.id WHERE t2.project_id=16074 %s) TO STDOUT%s',
                    $self->{sqlprefix},
                    $SELECT,
                    $source_tablename,
                    $mode eq 'fullcopy' ? '' : " AND t1.$Table->{pklist} = ANY(?)",
                    ...
                    $srccmd = sprintf '%sCOPY (%s FROM ONLY %s t1 INNER JOIN public.conversations t2 ON t1.conversation_identifier = t2.conversation_identifier WHERE t2.project_id=16074 %s) TO STDOUT%s',
                    $self->{sqlprefix},
                    $SELECT,
                    $source_tablename,
                    $mode eq 'fullcopy' ? '' : " AND t1.$Table->{pklist} = ANY(?)",
                    ...
                    $srccmd = sprintf '%sCOPY (%s FROM ONLY %s t1 INNER JOIN public.segments t2 ON t1.segment_id = t2.id WHERE t2.project_id=16074 %s) TO STDOUT%s',
                    $self->{sqlprefix},
                    $SELECT,
                    $source_tablename,
                    $mode eq 'fullcopy' ? '' : " AND t1.$Table->{pklist} = ANY(?)",
                    ...
                    $srccmd = sprintf '%sCOPY (%s FROM ONLY %s t1 INNER JOIN public.articles t2 ON t1.searchable_id = t2.id AND t1.searchable_type = \'Article\' WHERE t2.project_id=16074 %s) TO STDOUT%s',
                    $self->{sqlprefix},
                    $SELECT,
                    $source_tablename,
                    $mode eq 'fullcopy' ? '' : " AND t1.$Table->{pklist} = ANY(?)",
                    ...
                    $srccmd = sprintf '%sCOPY (%s FROM ONLY %s t1 INNER JOIN public.ecommerce_categories t2 ON t1.ecommerce_category_id = t2.id WHERE t2.project_id=16074 %s) TO STDOUT%s',
                    $self->{sqlprefix},
                    $SELECT,
                    $source_tablename,
                    $mode eq 'fullcopy' ? '' : " AND t1.$Table->{pklist} = ANY(?)",
                    ...
                    $srccmd = sprintf "%sCOPY (%s FROM ONLY %s t1 WHERE name ILIKE '%%project_zzkaeiod%%' %s) TO STDOUT%s",
                    $self->{sqlprefix},
                    $SELECT,
                    $source_tablename,
                    $mode eq 'fullcopy' ? '' : " AND t1.$Table->{pklist} = ANY(?)",
                    ...
                    $srccmd = sprintf '%sCOPY (%s FROM ONLY %s t1 INNER JOIN public.scheduled_meetings t2 ON t1.scheduled_meeting_id = t2.id WHERE t2.project_id=16074 %s) TO STDOUT%s',
                    $self->{sqlprefix},
                    $SELECT,
                    $source_tablename,
                    $mode eq 'fullcopy' ? '' : " AND t1.$Table->{pklist} = ANY(?)",
                    ...
                    $srccmd = sprintf '%sCOPY (%s FROM ONLY %s t1 INNER JOIN public.pipelines t2 ON t1.pipeline_id = t2.id WHERE t2.project_id=16074 %s) TO STDOUT%s',
                    $self->{sqlprefix},
                    $SELECT,
                    $source_tablename,
                    $mode eq 'fullcopy' ? '' : " AND t1.$Table->{pklist} = ANY(?)",
                    ...
                    $srccmd = sprintf '%sCOPY (%s FROM ONLY %s t1 INNER JOIN public.support_bot_analytics t2 ON t1.support_bot_analytics_id = t2.id WHERE t2.project_id=16074 %s) TO STDOUT%s',
                    $self->{sqlprefix},
                    $SELECT,
                    $source_tablename,
                    $mode eq 'fullcopy' ? '' : " AND t1.$Table->{pklist} = ANY(?)",
                    ...
                    $srccmd = sprintf '%sCOPY (%s FROM ONLY %s t1 INNER JOIN public.surveys t2 ON t1.survey_id = t2.id WHERE t2.project_id=16074 %s) TO STDOUT%s',
                    $self->{sqlprefix},
                    $SELECT,
                    $source_tablename,
                    $mode eq 'fullcopy' ? '' : " AND t1.$Table->{pklist} = ANY(?)",
                    ...
                    $srccmd = sprintf '%sCOPY (%s FROM ONLY %s t1 INNER JOIN public.teams t2 ON t1.team_id = t2.id WHERE t2.project_id=16074 %s) TO STDOUT%s',
                    $self->{sqlprefix},
                    $SELECT,
                    $source_tablename,
                    $mode eq 'fullcopy' ? '' : " AND t1.$Table->{pklist} = ANY(?)",
                    ...
                    $srccmd = sprintf '%sCOPY (%s FROM ONLY %s t1 INNER JOIN public.tours t2 ON t1.tour_id = t2.id WHERE t2.project_id=16074 %s) TO STDOUT%s',
                    $self->{sqlprefix},
                    $SELECT,
                    $source_tablename,
                    $mode eq 'fullcopy' ? '' : " AND t1.$Table->{pklist} = ANY(?)",
                    ...
                    $srccmd = sprintf '%sCOPY (%s FROM ONLY %s t1 INNER JOIN public.triggered_chats t2 ON t1.triggered_chat_id = t2.id WHERE t2.project_id=16074 %s) TO STDOUT%s',
                    $self->{sqlprefix},
                    $SELECT,
                    $source_tablename,
                    $mode eq 'fullcopy' ? '' : " AND t1.$Table->{pklist} = ANY(?)",
                    ...
                    $srccmd = sprintf '%sCOPY (%s FROM ONLY %s t1 INNER JOIN public.workflows t2 ON t1.workflow_id = t2.id WHERE t2.project_id=16074 %s) TO STDOUT%s',
                    $self->{sqlprefix},
                    $SELECT,
                    $source_tablename,
                    $mode eq 'fullcopy' ? '' : " AND t1.$Table->{pklist} = ANY(?)",
                ...
                ## Three Level copy logics
                    ...
                    $srccmd = sprintf '%sCOPY (%s FROM ONLY %s t1 INNER JOIN public.questions t2 ON t1.question_id = t2.id INNER JOIN public.bots t3 ON t2.bot_id = t3.id WHERE t3.project_id=16074 %s) TO STDOUT%s',
                    $self->{sqlprefix},
                    $SELECT,
                    $source_tablename,
                    $mode eq 'fullcopy' ? '' : " AND t1.$Table->{pklist} = ANY(?)",
                    ...
                    $srccmd = sprintf '%sCOPY (%s FROM ONLY %s t1 INNER JOIN public.company_notes t2 ON t1.company_note_id = t2.id INNER JOIN public.companies t3 ON t2.company_id = t3.id WHERE t3.project_id=16074 %s) TO STDOUT%s',
                    $self->{sqlprefix},
                    $SELECT,
                    $source_tablename,
                    $mode eq 'fullcopy' ? '' : " AND t1.$Table->{pklist} = ANY(?)",
                ...
                ## Two Level logic 
                    ...
                    $srccmd = sprintf '%sCOPY (%s FROM ONLY %s t1 INNER JOIN public.crm_emails t2 ON t1.crm_email_id = t2.id WHERE t2.project_id=16074 %s) TO STDOUT%s',
                    $self->{sqlprefix},
                    $SELECT,
                    $source_tablename,
                    $mode eq 'fullcopy' ? '' : " AND t1.$Table->{pklist} = ANY(?)",
                    ...
                    $srccmd = sprintf '%sCOPY (%s FROM ONLY %s t1 INNER JOIN public.deal_notes t2 ON t1.deal_note_id = t2.id INNER JOIN public.deals t3 ON t2.deal_id = t3.id WHERE t3.project_id=16074 %s) TO STDOUT%s',
                    $self->{sqlprefix},
                    $SELECT,
                    $source_tablename,
                    $mode eq 'fullcopy' ? '' : " AND t1.$Table->{pklist} = ANY(?)",
                    ...
                    $srccmd = sprintf '%sCOPY (%s FROM ONLY %s t1 INNER JOIN public.charges t2 ON t1.charge_id = t2.id WHERE t2.project_id=16074 %s) TO STDOUT%s',
                    $self->{sqlprefix},
                    $SELECT,
                    $source_tablename,
                    $mode eq 'fullcopy' ? '' : " AND t1.$Table->{pklist} = ANY(?)",
                    ...
                    $srccmd = sprintf '%sCOPY (%s FROM ONLY %s t1 INNER JOIN public.people_identifiers t2 ON t1.people_identifier_id = t2.id INNER JOIN public.people t3 ON t2.person_id = t3.id WHERE t3.project_id=16074 %s) TO STDOUT%s',
                    $self->{sqlprefix},
                    $SELECT,
                    $source_tablename,
                    $mode eq 'fullcopy' ? '' : " AND t1.$Table->{pklist} = ANY(?)",
