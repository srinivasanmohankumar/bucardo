    ...
    for my $select_clause (sort keys %srccmd) {
        ...
        for my $pk_values (@pkvals) {
            ...
            if ($mode eq 'fullcopy' or $mode eq 'anyclause') {
                ...
                #modifying target columns in select based on target table structure

                if($target_tablename eq 'amazon_ads_advertised_product_reports'){
                    $SELECT = 'SELECT id, report_date, account_id, channel_id, profile_id, campaign_id, ad_group_id, ad_id, portfolio_id, created_at, updated_at, add_to_cart, add_to_cart_clicks,"addToCartViews" as add_to_cart_views, add_to_list, add_to_list_from_clicks, add_to_list_from_views, branded_searches, branded_searches_clicks, branded_searches_views, clicks, cumulative_reach, detail_page_views, detail_page_views_clicks, impressions, impressions_views, kindle_edition_normalized_pages_read14d, kindle_edition_normalized_pages_royalties14d, lead_form_opens, leads, link_outs, new_to_brand_detail_page_view_clicks, new_to_brand_detail_page_view_views, new_to_brand_detail_page_views, new_to_brand_purchases, new_to_brand_purchases_clicks, new_to_brand_units_sold, new_to_brand_units_sold_clicks, purchases14d, purchases1d, purchases30d, purchases7d, purchases_clicks, purchases_same_sku14d, purchases_same_sku1d, purchases_same_sku30d, purchases_same_sku7d, qualified_borrows, qualified_borrows_from_clicks, qualified_borrows_from_views, units_sold14d, units_sold_clicks14d, units_sold_clicks1d, units_sold_clicks30d, units_sold_clicks7d, units_sold_other_sku7d, units_sold_same_sku14d, units_sold_same_sku1d, units_sold_same_sku30d, units_sold_same_sku7d, video_complete_views, video_first_quartile_views, video_midpoint_views, video_third_quartile_views, video_unmutes, royalty_qualified_borrows, royalty_qualified_borrows_from_clicks, royalty_qualified_borrows_from_views, acos_clicks14d, acos_clicks7d, add_to_cart_rate, attributed_sales_same_sku14d, attributed_sales_same_sku1d, attributed_sales_same_sku30d, attributed_sales_same_sku7d, branded_search_rate, campaign_budget_amount, click_through_rate, cost, cost_per_click, ecp_add_to_cart, ecp_brand_search, impressions_frequency_average, new_to_brand_detail_page_view_rate, new_to_brand_ecp_detail_page_view, new_to_brand_sales, new_to_brand_sales_clicks, roas_clicks14d, roas_clicks7d, sales14d, sales1d, sales30d, sales7d, sales_other_sku7d, sales_clicks, spend, view_click_through_rate, viewability_rate, converted_acos_clicks14d, converted_acos_clicks7d, converted_attributed_sales_same_sku14d, converted_attributed_sales_same_sku1d, converted_attributed_sales_same_sku30d, converted_attributed_sales_same_sku7d, converted_campaign_budget_amount, converted_cost, converted_cost_per_click, converted_ecp_add_to_cart, converted_ecp_brand_search, converted_new_to_brand_ecp_detail_page_view, converted_new_to_brand_sales, converted_new_to_brand_sales_clicks, converted_roas_clicks14d, converted_roas_clicks7d, converted_sales14d, converted_sales1d, converted_sales30d, converted_sales7d, converted_sales_other_sku7d, converted_sales_clicks, converted_spend, ad_group_name, asin, sku, bid_optimization, campaign_budget_currency_code, campaign_budget_type, campaign_type, campaign_name, campaign_status'
                    
                    my $srccmd = sprintf '%sCOPY (%s FROM ONLY %s WHERE record_type = \'productAds\' %s) TO STDOUT%s',
                    $self->{sqlprefix},
                    $SELECT,
                    $source_tablename,
                ...
                elsif($target_tablename eq 'amazon_ads_campaign_reports') {
                    $SELECT = 'SELECT id, report_date, account_id, channel_id, profile_id, campaign_id, "adgroup_id" as ad_group_id,"adId" as ad_id,NULL as portfolio_id,updated_at as created_at, updated_at,"addToCart" as add_to_cart,"addToCartClicks" as add_to_cart_clicks,"addToCartViews" as add_to_cart_views, NULL as add_to_list, NULL as add_to_list_from_clicks, NULL as add_to_list_from_views, "attributedDetailPageViewsClicks14d" as attributed_detail_page_views_clicks14d,"brandedSearches" as branded_searches,"attributedBrandedSearches14d" as branded_searches_clicks,"brandedSearchesViews" as branded_searches_views, clicks,"cumulativeReach" as cumulative_reach,"viewAttributedDetailPageView14d" as detail_page_views,"attributedDetailPageView14d" as detail_page_views_clicks,NULL as detail_page_views_views,NULL as household_reach, impressions,"viewImpressions" as  impressions_views,NULL as kindle_edition_normalized_pages_read14d,NULL as kindle_edition_normalized_pages_royalties14d,NULL as lead_form_opens,NULL as leads,NULL as link_outs,NULL as new_to_brand_detail_page_view_clicks,NULL as new_to_brand_detail_page_view_views,NULL as new_to_brand_detail_page_views,NULL as new_to_brand_purchases,NULL as new_to_brand_purchases_clicks,NULL as new_to_brand_purchases_views,NULL as new_to_brand_units_sold,NULL as new_to_brand_units_sold_clicks,NULL as purchases14d,NULL as purchases1d,NULL as purchases30d,NULL as purchases7d,NULL as purchases_clicks,NULL as purchases_same_sku14d,NULL as purchases_same_sku1d,NULL as purchases_same_sku30d,NULL as purchases_same_sku7d,NULL as purchases_views,NULL as qualified_borrows,NULL as qualified_borrows_from_clicks,NULL as qualified_borrows_from_views,NULL as reach,NULL as royalty_qualified_borrows,NULL as royalty_qualified_borrows_from_clicks,NULL as royalty_qualified_borrows_from_views,NULL as units_sold14d,NULL as units_sold_clicks14d,NULL as units_sold_clicks1d,NULL as units_sold_clicks30d,NULL as units_sold_clicks7d,NULL as units_sold_views,NULL as units_sold_same_sku14d,NULL as units_sold_same_sku1d,NULL as units_sold_same_sku30d,NULL as units_sold_same_sku7d,NULL as video5second_views,NULL as video_complete_views,NULL as video_first_quartile_views,NULL as video_midpoint_views,NULL as video_third_quartile_views,NULL as video_unmutes, "addToCartRate" as add_to_cart_rate,"attributedOrderRateNewToBrand14d" as attributed_order_rate_new_to_brand14d,"attributedSalesSameSku14d" as attributed_sales_same_sku14d,"attributedSalesSameSku1d" as attributed_sales_same_sku1d,"attributedSalesSameSku30d" as attributed_sales_same_sku30d,"attributedSalesSameSku30d" as attributed_sales_same_sku7d,"brandedSearchRate" as branded_search_rate,"campaignBudgetAmount" as campaign_budget_amount,"campaignRuleBasedBudgetAmount" as campaign_rule_based_budget_amount,"clickThroughRate" as click_through_rate, cost,"costPerClick" as cost_per_click,NULL as cost_per_thousand_impressions,"eCPAddToCart" as ecp_add_to_cart,"eCPBrandSearch" as ecp_brand_search, NULL as frequency_average,NULL as household_frequency_average,"impressionsFrequencyAverage" as impressions_frequency_average,NULL as new_to_brand_detail_page_view_rate,NULL as new_to_brand_ecp_detail_page_view,NULL as new_to_brand_purchases_percentage,NULL as new_to_brand_sales,NULL as new_to_brand_sales_clicks,NULL as new_to_brand_sales_percentage,NULL as new_to_brand_sales_views,NULL as new_to_brand_units_sold_percentage,NULL as roas,NULL as sales14d,NULL as sales1d,NULL as sales30d,NULL as sales7d,NULL as sales_clicks,NULL as sales_views,NULL as spend,NULL as video5second_view_rate,NULL as view_click_through_rate,NULL as viewability_rate,NULL as converted_attributed_sales_same_sku14d,NULL as converted_attributed_sales_same_sku1d,NULL as converted_attributed_sales_same_sku30d,NULL as converted_attributed_sales_same_sku7d,NULL as converted_campaign_budget_amount,NULL as converted_campaign_rule_based_budget_amount,NULL as converted_cost,NULL as converted_cost_per_click,NULL as converted_cost_per_thousand_impressions,NULL as converted_ecp_add_to_cart,NULL as converted_ecp_brand_search,NULL as converted_new_to_brand_ecp_detail_page_view,NULL as converted_new_to_brand_sales,NULL as converted_new_to_brand_sales_clicks,NULL as converted_new_to_brand_sales_views,NULL as converted_roas,NULL as converted_sales14d,NULL as converted_sales1d,NULL as converted_sales30d,NULL as converted_sales7d,NULL as converted_sales_clicks,NULL as converted_sales_views,NULL as converted_spend, "adgroup_name" as ad_group_name, "adStatus" as ad_status,"bidOptimization" as bid_optimization, "campaignApplicableBudgetRuleId" as campaign_applicable_budget_rule_id,"campaignApplicableBudgetRuleName" as campaign_applicable_budget_rule_name,NULL as campaign_bidding_strategy,"currency" as campaign_budget_currency_code,"campaignBudgetType" as campaign_budget_type, campaign_name, campaign_status, campaign_type'
                    
                    my $srccmd = sprintf '%sCOPY (%s FROM ONLY %s WHERE record_type = \'ad_group\' %s) TO STDOUT%s',
                    $self->{sqlprefix},
                    $SELECT,
                    $source_tablename,
                    $mode eq 'fullcopy' ? '' : " WHERE $Table->{pklist} = ANY(?)",
                ...
                elsif($target_tablename eq 'amazon_ads_placement_reports') {
                    $SELECT = 'SELECT id, report_date, account_id, channel_id, profile_id, campaign_id, created_at, updated_at, add_to_list, attributed_detail_page_views_clicks14d, branded_searches, clicks, detail_page_views_clicks, impressions, impressions_views, kindle_edition_normalized_pages_read14d, kindle_edition_normalized_pages_royalties14d, qualified_borrows, new_to_brand_purchases, new_to_brand_units_sold, purchases14d, purchases1d, purchases30d, purchases7d, purchases_same_sku14d, purchases_same_sku1d, purchases_same_sku30d, purchases_same_sku7d, royalty_qualified_borrows, units_sold14d, units_sold_clicks14d, units_sold_clicks1d, units_sold_clicks30d, units_sold_clicks7d, units_sold_same_sku14d, units_sold_same_sku1d, units_sold_same_sku30d, units_sold_same_sku7d, NULL as video5second_views,NULL as video_complete_views,NULL as video_first_quartile_views,NULL as video_midpoint_views,NULL as video_third_quartile_views, video_unmutes, attributed_order_rate_new_to_brand14d, attributed_sales_same_sku14d, attributed_sales_same_sku1d, attributed_sales_same_sku30d, attributed_sales_same_sku7d, campaign_budget_amount, campaign_rule_based_budget_amount, click_through_rate, cost, cost_per_click, new_to_brand_purchases_percentage, new_to_brand_sales, new_to_brand_sales_percentage, new_to_brand_units_sold_percentage, sales14d, sales1d, sales30d, sales7d, spend, video5second_view_rate, view_click_through_rate, viewability_rate, top_of_search_impression_share, converted_attributed_sales_same_sku14d, converted_attributed_sales_same_sku1d, converted_attributed_sales_same_sku30d, converted_attributed_sales_same_sku7d, converted_campaign_budget_amount, converted_campaign_rule_based_budget_amount, converted_cost, converted_cost_per_click, converted_new_to_brand_sales, converted_sales14d, converted_sales1d, converted_sales30d, converted_sales7d, converted_spend, campaign_applicable_budget_rule_id, campaign_applicable_budget_rule_name, campaign_bidding_strategy, campaign_budget_currency_code, campaign_budget_type, campaign_name, campaign_status, campaign_type, placement_classification'
                    
                    my $srccmd = sprintf '%sCOPY (%s FROM ONLY %s WHERE record_type = \'placement\' %s) TO STDOUT%s',
                    $self->{sqlprefix},
                    $SELECT,
                    $source_tablename,
                    $mode eq 'fullcopy' ? '' : " WHERE $Table->{pklist} = ANY(?)",
                ...
                elsif($target_tablename eq 'amazon_ads_target_reports') {
                    $SELECT = 'SELECT id, report_date, account_id, channel_id, profile_id, campaign_id, created_at, updated_at, add_to_list, attributed_detail_page_views_clicks14d, branded_searches, clicks, detail_page_views_clicks, impressions, impressions_views, kindle_edition_normalized_pages_read14d, kindle_edition_normalized_pages_royalties14d, qualified_borrows, new_to_brand_purchases, new_to_brand_units_sold, purchases14d, purchases1d, purchases30d, purchases7d, purchases_same_sku14d, purchases_same_sku1d, purchases_same_sku30d, purchases_same_sku7d, royalty_qualified_borrows, units_sold14d, units_sold_clicks14d, units_sold_clicks1d, units_sold_clicks30d, units_sold_clicks7d, units_sold_same_sku14d, units_sold_same_sku1d, units_sold_same_sku30d, units_sold_same_sku7d, video5second_views, video_complete_views, video_first_quartile_views, video_midpoint_views, video_third_quartile_views, video_unmutes, attributed_order_rate_new_to_brand14d, attributed_sales_same_sku14d, attributed_sales_same_sku1d, attributed_sales_same_sku30d, attributed_sales_same_sku7d, campaign_budget_amount, campaign_rule_based_budget_amount, click_through_rate, cost, cost_per_click, new_to_brand_purchases_percentage, new_to_brand_sales, new_to_brand_sales_percentage, new_to_brand_units_sold_percentage, sales14d, sales1d, sales30d, sales7d, spend, video5second_view_rate, view_click_through_rate, viewability_rate, top_of_search_impression_share, converted_attributed_sales_same_sku14d, converted_attributed_sales_same_sku1d, converted_attributed_sales_same_sku30d, converted_attributed_sales_same_sku7d, converted_campaign_budget_amount, converted_campaign_rule_based_budget_amount, converted_cost, converted_cost_per_click, converted_new_to_brand_sales, converted_sales14d, converted_sales1d, converted_sales30d, converted_sales7d, converted_spend, campaign_applicable_budget_rule_id, campaign_applicable_budget_rule_name, campaign_bidding_strategy, campaign_budget_currency_code, campaign_budget_type, campaign_name, campaign_status, campaign_type, placement_classification'
                    
                    my $srccmd = sprintf '%sCOPY (%s FROM ONLY %s WHERE record_type IN (\'target\', \'keyword\', \'matched_target\') %s) TO STDOUT%s',
                    $self->{sqlprefix},
                    $SELECT,
                    $source_tablename,
                    $mode eq 'fullcopy' ? '' : " WHERE $Table->{pklist} = ANY(?)",
                ...
                elsif($target_tablename eq 'amazon_ads_search_term_reports') {
                    $SELECT = 'SELECT id, report_date, account_id, channel_id, profile_id, campaign_id, created_at, updated_at, add_to_list, attributed_detail_page_views_clicks14d, branded_searches, clicks, detail_page_views_clicks, impressions, impressions_views, kindle_edition_normalized_pages_read14d, kindle_edition_normalized_pages_royalties14d, qualified_borrows, new_to_brand_purchases, new_to_brand_units_sold, purchases14d, purchases1d, purchases30d, purchases7d, purchases_same_sku14d, purchases_same_sku1d, purchases_same_sku30d, purchases_same_sku7d, royalty_qualified_borrows, units_sold14d, units_sold_clicks14d, units_sold_clicks1d, units_sold_clicks30d, units_sold_clicks7d, units_sold_same_sku14d, units_sold_same_sku1d, units_sold_same_sku30d, units_sold_same_sku7d, video5second_views, video_complete_views, video_first_quartile_views, video_midpoint_views, video_third_quartile_views, video_unmutes, attributed_order_rate_new_to_brand14d, attributed_sales_same_sku14d, attributed_sales_same_sku1d, attributed_sales_same_sku30d, attributed_sales_same_sku7d, campaign_budget_amount, campaign_rule_based_budget_amount, click_through_rate, cost, cost_per_click, new_to_brand_purchases_percentage, new_to_brand_sales, new_to_brand_sales_percentage, new_to_brand_units_sold_percentage, sales14d, sales1d, sales30d, sales7d, spend, video5second_view_rate, view_click_through_rate, viewability_rate, top_of_search_impression_share, converted_attributed_sales_same_sku14d, converted_attributed_sales_same_sku1d, converted_attributed_sales_same_sku30d, converted_attributed_sales_same_sku7d, converted_campaign_budget_amount, converted_campaign_rule_based_budget_amount, converted_cost, converted_cost_per_click, converted_new_to_brand_sales, converted_sales14d, converted_sales1d, converted_sales30d, converted_sales7d, converted_spend, campaign_applicable_budget_rule_id, campaign_applicable_budget_rule_name, campaign_bidding_strategy, campaign_budget_currency_code, campaign_budget_type, campaign_name, campaign_status, campaign_type, placement_classification'
                    
                    my $srccmd = sprintf '%sCOPY (%s FROM ONLY %s WHERE record_type = \'search_term\' %s) TO STDOUT%s',
                    $self->{sqlprefix},
                    $SELECT,
                    $source_tablename,
                    $mode eq 'fullcopy' ? '' : " WHERE $Table->{pklist} = ANY(?)",
                ...
                elsif($target_tablename eq 'amazon_ads_purchased_product_reports') {
                    $SELECT = 'SELECT id, report_date, account_id, channel_id, profile_id, campaign_id, created_at, updated_at, add_to_list, attributed_detail_page_views_clicks14d, branded_searches, clicks, detail_page_views_clicks, impressions, impressions_views, kindle_edition_normalized_pages_read14d, kindle_edition_normalized_pages_royalties14d, qualified_borrows, new_to_brand_purchases, new_to_brand_units_sold, purchases14d, purchases1d, purchases30d, purchases7d, purchases_same_sku14d, purchases_same_sku1d, purchases_same_sku30d, purchases_same_sku7d, royalty_qualified_borrows, units_sold14d, units_sold_clicks14d, units_sold_clicks1d, units_sold_clicks30d, units_sold_clicks7d, units_sold_same_sku14d, units_sold_same_sku1d, units_sold_same_sku30d, units_sold_same_sku7d, video5second_views, video_complete_views, video_first_quartile_views, video_midpoint_views, video_third_quartile_views, video_unmutes, attributed_order_rate_new_to_brand14d, attributed_sales_same_sku14d, attributed_sales_same_sku1d, attributed_sales_same_sku30d, attributed_sales_same_sku7d, campaign_budget_amount, campaign_rule_based_budget_amount, click_through_rate, cost, cost_per_click, new_to_brand_purchases_percentage, new_to_brand_sales, new_to_brand_sales_percentage, new_to_brand_units_sold_percentage, sales14d, sales1d, sales30d, sales7d, spend, video5second_view_rate, view_click_through_rate, viewability_rate, top_of_search_impression_share, converted_attributed_sales_same_sku14d, converted_attributed_sales_same_sku1d, converted_attributed_sales_same_sku30d, converted_attributed_sales_same_sku7d, converted_campaign_budget_amount, converted_campaign_rule_based_budget_amount, converted_cost, converted_cost_per_click, converted_new_to_brand_sales, converted_sales14d, converted_sales1d, converted_sales30d, converted_sales7d, converted_spend, campaign_applicable_budget_rule_id, campaign_applicable_budget_rule_name, campaign_bidding_strategy, campaign_budget_currency_code, campaign_budget_type, campaign_name, campaign_status, campaign_type, placement_classification'
                    
                    my $srccmd = sprintf '%sCOPY (%s FROM ONLY %s WHERE record_type = \'purchased_product\' %s) TO STDOUT%s',
                    $self->{sqlprefix},
                    $SELECT,
                    $source_tablename,
                    $mode eq 'fullcopy' ? '' : " WHERE $Table->{pklist} = ANY(?)",
                ...
                elsif($target_tablename eq 'amazon_ads_ad_reports') {
                    $SELECT = 'SELECT id, report_date, account_id, channel_id, profile_id, campaign_id, created_at, updated_at, add_to_list, attributed_detail_page_views_clicks14d, branded_searches, clicks, detail_page_views_clicks, impressions, impressions_views, kindle_edition_normalized_pages_read14d, kindle_edition_normalized_pages_royalties14d, qualified_borrows, new_to_brand_purchases, new_to_brand_units_sold, purchases14d, purchases1d, purchases30d, purchases7d, purchases_same_sku14d, purchases_same_sku1d, purchases_same_sku30d, purchases_same_sku7d, royalty_qualified_borrows, units_sold14d, units_sold_clicks14d, units_sold_clicks1d, units_sold_clicks30d, units_sold_clicks7d, units_sold_same_sku14d, units_sold_same_sku1d, units_sold_same_sku30d, units_sold_same_sku7d, video5second_views, video_complete_views, video_first_quartile_views, video_midpoint_views, video_third_quartile_views, video_unmutes, attributed_order_rate_new_to_brand14d, attributed_sales_same_sku14d, attributed_sales_same_sku1d, attributed_sales_same_sku30d, attributed_sales_same_sku7d, campaign_budget_amount, campaign_rule_based_budget_amount, click_through_rate, cost, cost_per_click, new_to_brand_purchases_percentage, new_to_brand_sales, new_to_brand_sales_percentage, new_to_brand_units_sold_percentage, sales14d, sales1d, sales30d, sales7d, spend, video5second_view_rate, view_click_through_rate, viewability_rate, top_of_search_impression_share, converted_attributed_sales_same_sku14d, converted_attributed_sales_same_sku1d, converted_attributed_sales_same_sku30d, converted_attributed_sales_same_sku7d, converted_campaign_budget_amount, converted_campaign_rule_based_budget_amount, converted_cost, converted_cost_per_click, converted_new_to_brand_sales, converted_sales14d, converted_sales1d, converted_sales30d, converted_sales7d, converted_spend, campaign_applicable_budget_rule_id, campaign_applicable_budget_rule_name, campaign_bidding_strategy, campaign_budget_currency_code, campaign_budget_type, campaign_name, campaign_status, campaign_type, placement_classification'
                    
                    my $srccmd = sprintf '%sCOPY (%s FROM ONLY %s WHERE record_type = \'ad\' %s) TO STDOUT%s',
                    $self->{sqlprefix},
                    $SELECT,
                    $source_tablename,
                    $mode eq 'fullcopy' ? '' : " WHERE $Table->{pklist} = ANY(?)",
